...
import tma.sdc.DictionaryDatabase;
...
public class SuggestionProvider extends ContentProvider {
	//public static final Uri CONTENT_URI =  Uri.parse("content://tma.sdc.SuggestionProvider");
	
	//////////////////
	String TAG = "DictionaryProvider";

    public static String AUTHORITY = "tma.sdc.SuggestionProvider";
...
//    private DictionaryDatabase mDictionary;
	...
	public boolean onCreate() {
		SQLiteDataProvider sdp=null;
		   ...
		   if(sdp!=null)
		   {
			  this.mDictionary=new Dictionary(sdp);
		   }
		   return true;
	}
