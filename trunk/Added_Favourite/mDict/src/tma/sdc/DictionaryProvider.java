...
public class DictionaryProvider extends ContentProvider {
    ...
    public static String AUTHORITY = "tma.sdc.DictionaryProvider";
    ...
    private Cursor getSuggestions(String query) {
      ...
      Cursor cs = mDictionary.getWordMatches(query);
      if(mDictionary != null)
    	  mDictionary.close();
      return cs;
    }
    ...
    private Cursor getWord(Uri uri) {
      ...
      if(mDictionary == null)
  		mDictionary = new DictionaryDatabase(getContext());
      Cursor cs = mDictionary.getWord(word);
    if(mDictionary != null)
  	  mDictionary.close();      
    return cs;
    }
    ...
    private Cursor refreshShortcut(Uri uri) {
       ...
       */
        ...
        if(mDictionary == null)
    		mDictionary = new DictionaryDatabase(getContext());
        Cursor cs = mDictionary.getWordRefresh(word);
      if(mDictionary != null)
    	  mDictionary.close();    
