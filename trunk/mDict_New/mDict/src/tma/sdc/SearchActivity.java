...
//			    	int dindew = cs.getColumnIndexOrThrow(DictionaryDatabase.KEY_DEFINITION);
//			    	String dresult = cs.getString(dindew);
//			    	String wresult = cs.getString(dindew);
//			    	try{
//						wb.loadDataWithBaseURL("file:///android_asset/",html+dresult, "text/html", "utf-8", null);
//						   this.leftText.setText(this.getString(R.string.app_name));
//						  this.rightText.setText(wresult);
//						}
//						catch(Exception ex)
//						{
